...
![](https://ragflow.io/assets/images/2025racap-5215bb012cb35bcba2948e9a38d334b2.PNG)
...
![](https://ragflow.io/assets/images/1-f4082244d08298c8b69bb72e87420723.PNG)
...
Can RAG still be improved?[](#can-rag-still-be-improved "Direct link to Can RAG still be improved?")
----------------------------------------------------------------------------------------------------

### The debate about long context and RAG[](#the-debate-about-long-context-and-rag "Direct link to The debate about long context and RAG")
...
### Optimizations for RAG conversational quality[](#optimizations-for-rag-conversational-quality "Direct link to Optimizations for RAG conversational quality")
...
![](https://ragflow.io/assets/images/long_context_rag-ce3571325c14059bc00471b9e86cebca.PNG)
...
### From knowledge base to data foundation[](#from-knowledge-base-to-data-foundation "Direct link to From knowledge base to data foundation")
...
![](https://ragflow.io/assets/images/etl_vs-18ee60c39ef08db644444af995e49e3a.png)
...
From RAG to context[](#from-rag-to-context "Direct link to From RAG to context")
--------------------------------------------------------------------------------
...
### How is retrieval for Agents different from the search era?[](#how-is-retrieval-for-agents-different-from-the-search-era "Direct link to How is retrieval for Agents different from the search era?")
...
![](https://ragflow.io/assets/images/agent_retrieval-048b662c8cf3f98e78dbb9eaa64ab29e.png)
...
### Tools also need searching[](#tools-also-need-searching "Direct link to Tools also need searching")
...
![](https://ragflow.io/assets/images/tool_retrieval-32f59e28a638ff81eaf822a67a962607.png)
...
### Does memory deserve to be a separate infra?[](#does-memory-deserve-to-be-a-separate-infra "Direct link to Does memory deserve to be a separate infra?")
...
![](https://ragflow.io/assets/images/memory_infra-5464678a3d0c427f263758a408ad8b6f.png)
...
![](https://ragflow.io/assets/images/context_engineering-3904e6110c9e7aaffb357bb96cca0b80.png)

How far has multi-modal RAG progressed?[](#how-far-has-multi-modal-rag-progressed "Direct link to How far has multi-modal RAG progressed?")
-------------------------------------------------------------------------------------------------------------------------------------------
...
![](https://ragflow.io/assets/images/multimodal_path-99f59e049f169d2bb6086454981357ea.png)
...
![](https://ragflow.io/assets/images/doc_retrieval-ac362740de513961c064fdafa718c833.png)
...
Looking ahead to 2026[](#looking-ahead-to-2026 "Direct link to Looking ahead to 2026")
--------------------------------------------------------------------------------------
...
1.  AlayaDB: The Data Foundation for Efficient and Effective Long-context LLM Inference [https://arxiv.org/abs/2504.10326](https://arxiv.org/abs/2504.10326)?
2.  [https://github.com/VectifyAI/PageIndex](https://github.com/VectifyAI/PageIndex)
3.  A Systematic Framework for Enterprise Knowledge Retrieval: Leveraging LLM-Generated Metadata to Enhance RAG Systems [https://arxiv.org/abs/2512.05411](https://arxiv.org/abs/2512.05411)
4.  M3Retrieve: Benchmarking Multimodal Retrieval for Medicine [https://arxiv.org/abs/2510.06888](https://arxiv.org/abs/2510.06888)
5.  On the Theoretical Limitations of Embedding-Based Retrieval [https://arxiv.org/abs/2508.21038](https://arxiv.org/abs/2508.21038)
6.  MUVERA: Multi-Vector Retrieval via Fixed Dimensional Encodings [https://arxiv.org/abs/2405.19504](https://arxiv.org/abs/2405.19504)
7.  [https://www.lateinteraction.com/](https://www.lateinteraction.com/)
8.  [https://huggingface.co/blog/QuentinJG/introducing-vidore-v3](https://huggingface.co/blog/QuentinJG/introducing-vidore-v3)
9.  诞生才一周年，MCP凉了 [https://mp.weixin.qq.com/s/LskoLb8g6t\_PCGNSvlLh6g](https://mp.weixin.qq.com/s/LskoLb8g6t_PCGNSvlLh6g)
10.  [https://huggingface.co/datasets/bowang0911/ToolSearch](https://huggingface.co/datasets/bowang0911/ToolSearch)
11.  Dspy GEPA [https://dspy.ai/api/optimizers/GEPA/overview/](https://dspy.ai/api/optimizers/GEPA/overview/)
12.  Agentic Context Engineering: Evolving Contexts for Self-Improving Language Models [https://arxiv.org/abs/2510.04618](https://arxiv.org/abs/2510.04618)
13.  Why the Business Context Layer Is the Key to Making AI Work in Enterprise [https://theoryvc.com/blog-posts/business-context-layer](https://theoryvc.com/blog-posts/business-context-layer)
14.  From Context Engineering to Context Platforms [https://theoryvc.com/blog-posts/from-context-engineering-to-context-platforms](https://theoryvc.com/blog-posts/from-context-engineering-to-context-platforms)
15.  [https://www.linkedin.com/pulse/every-llm-company-search-hard-future-retrieval-systems-7zigc/](https://www.linkedin.com/pulse/every-llm-company-search-hard-future-retrieval-systems-7zigc/)
16.  MemVerse: Multimodal Memory for Lifelong Learning Agents [https://arxiv.org/abs/2512.03627](https://arxiv.org/abs/2512.03627)
